...
const About = () => {
  return (
    <div name='about' className='w-full h-screen bg-[#1e1c27] text-[#e3d2b4] md:h-screen'>
      <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full md:h-full text-[#e3d2b4]'>
        <div className='pb-8'>
          <p className='text-5xl font-bold flex justify-center'> Sobre Mi</p>
        </div>
        <p className='md:text-xl text-md mt-10'>
